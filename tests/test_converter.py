...
def test_convert_build_mdown() -> None:
    """ test convert_mdown & build_mdown w/o synonyms """
    mdown = "[aaa](A) [bbb](B) [ccc](C) [ddd](D)"
    query = "aaa bbb ccc ddd"
    spans = [("A", 0, 3, "aaa"), ("B", 4, 7, "bbb"), ("C", 8, 11, "ccc"), ("D", 12, 15, "ddd")]
    datas = (query, "", spans)
...
def test_convert_build_mdown_syns() -> None:
    """ test convert_mdown & build_mdown w/ synonyms """
...
def test_convert_build_conll() -> None:
    """ test convert_conll & build_conll """
    conll = [("aaa", "B-A"), ("bbb", "B-B"), ("ccc", "B-C"), ("ddd", "B-D")]
    query = "aaa bbb ccc ddd"
    spans = [("A", 0, 3, "aaa"), ("B", 4, 7, "bbb"), ("C", 8, 11, "ccc"), ("D", 12, 15, "ddd")]
    datas = (query, "", spans)
...
def test_convert_build_parse() -> None:
    """ test convert_parse & build_parse """
    query = "aaa bbb ccc ddd"
    spans = [("A", 0, 3, "aaa"), ("B", 4, 7, "bbb"), ("C", 8, 11, "ccc"), ("D", 12, 15, "ddd")]
    datas = (query, "", spans)
    parse = {"query": query,
